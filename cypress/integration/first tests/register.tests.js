...
describe("Registration Page", () => {
    ...
    it("Fill out LandLord registration password bellow minimum number of chars", () => {
        ...
        cy.get('#signup_submit').click();
        cy.get('#password_errormsg').contains('Password should have at least 8 characters')
    ...
    it("Fill out valid data for registration", () => {
        ...
        cy.get('*[class^="RadioGroup_radioRow RadioGroup_horizontalRow SignupForm_radioRowClassName"]').first().click();
